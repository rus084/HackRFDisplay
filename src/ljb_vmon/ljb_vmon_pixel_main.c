    ...
    )
{
    ...
    pDeviceInfo->VMONThreadExit = FALSE;
    while (!pDeviceInfo->VMONThreadExit)
    {
    ...
    )
{
    ...
    MyEDID[54 + NumOfDetailedTiming*18 + 5] = 45;       //56 Hz
    MyEDID[54 + NumOfDetailedTiming*18 + 6] = 60;       //60 Hz
    MyEDID[54 + NumOfDetailedTiming*18 + 7] = 12;       //30 KHz
